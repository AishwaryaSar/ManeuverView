package com.example.navigationtrial
...
import com.example.navigationtrial.R
import com.example.navigationtrial.databinding.ActivityMainBinding
...
import com.example.navigationtrial.LocationPermissionHelper
...
// specify frame of reference from the center.
    ...
    private fun startSimulation() {
        mapboxReplayer.run {
            stop()
            clearEvents()
            pushRealLocation( this@MainActivity , 0.0)
